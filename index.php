...
<link href="https://fonts.googleapis.com/css2?family=Source+Serif+4:wght@400;600&amp;family=IBM+Plex+Mono:wght@500&amp;display=block" rel="stylesheet">
    ...
    <meta name="itly-controller" content="welcome">
...
.tailor{
  ...
  margin-bottom: 60px;
  background-color: #000;
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(img/Untitled_design_-_2023-01-20T113740.994.webp);
...
.exp_img .img .desc{
  ...
  opacity: 0.6;
        ...
        <section class="hero" data-track-location="Header">
          ...
          <div class="tailor">
            <div class="hype" data-aos="fade-up" data-aos-duration="3000" data-aos-once="true">
              <h2 style="color: #fff;">Active Designers Ready to Customize a Brand for you!!</h2>
    ...
    <footer id="footer" class="section-p1">
        ...
        <div class="copyright">
            <p>&#169; 2021,Powered By Joshkaytech - Online Kay_Jay_Boutique</p>
        </div>
    </footer> 
</div>
  ...
  dots[slideIndex-1].className += " active";
    ...
    <script>
        function show() {
            ...
            Toast.classList.add('show'); // Add the 'show' class to trigger the animation
        }
        ...
        function closePopUp() {
            ...
            Toast.classList.remove('show'); // Remove the 'show' class to hide the pop-up
        }
    </script>
</body>
</html>
