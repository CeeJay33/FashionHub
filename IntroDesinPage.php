...
<form id="regForm" action="" method="post">
  ...
  <div class="tab"><strong> Provide your country:</strong>
    <div class="autocomplete" style="width:300px;">
        <input id="myInput" type="text" name="myCountry" oninput="this.className" placeholder="Country">
      </div>
  </div>
  <div class="tab">Additional Contact Info:
    <p><input placeholder="Address..." oninput="this.className = ''" name="address"></p>
    <p><input placeholder="Phone..." oninput="this.className = ''" name="phone"></p>
  </div>
  <div class="tab">Categories:
    <p><input placeholder="Clothes Designs..." oninput="this.className = ''" name="cloth"></p>
...
<script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Initialize AOS when the DOM is loaded
            AOS.init({
                duration: 3000,
                once: true,
            });
